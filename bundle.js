...
function loop() {
  requestAnimationFrame(loop); // slow game loop to 15 fps instead of 60 (60/15 = 4)
  ...
  snake.x += snake.dx;
  snake.y += snake.dy; // wrap snake position horizontally on edge of screen
  ...
  snake.cells.forEach(function (cell, index) {
    ...
    context.fillRect(cell.x, cell.y, grid - 1, grid - 1); // snake ate apple
